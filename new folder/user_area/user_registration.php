...
<body>
    <div class="container-fluid my-3">
        <h2 class="text-center text-danger"><u>New User Registration</u></h2>
            ...
            <div class="lg-12 col-xl-6">
                <form action="" method="post" enctype="multipart/form-data">
                    ...
                    <div class="form-outline mb-4 w-50 m-auto">
                        ...
                        <input type="text" id="user_mobile" class="form-control" placeholder="Enter your mobile number" 
                        autocomplete="off" required="required" name="user_mobile"/>
                    </div>
                    <div class="mt-4 pt-2 w-50 m-auto">
                        <input type="submit" value="Register" class="btn btn-danger px-3 mb-3 border-0" name="user_register"/>
                        <p class="small fw-bold mt-2 pt-1">Already have an account? <a href="user_login.php"
                        class="text-danger"> Login</a><br><a href="../index.php"
                        class="text-danger"> Go Back</a></p>
                    </div>
